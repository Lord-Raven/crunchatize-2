...
export class Stage extends StageBase<InitStateType, ChatStateType, MessageStateType, ConfigType> {
    ...
    buildResponsePrompt: (instruction: string) => string = (instruction: string) => {return `${this.buildSampleStatBlocks()}\n\n` +
        ...
        `${instruction}\n\nEnd the response by mechanically outputting the current statblock below, making logical updates as-needed to reflect changes to {{user}}'s status, based on events in the input and response: ` +
